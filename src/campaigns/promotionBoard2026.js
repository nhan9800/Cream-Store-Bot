...
export const PROMOTION_BOARD = Object.freeze({
  ...
  status: 'ACTIVE',
  campaign: 'CENAR-PUBG-TREND-SALE-2026',
});
...
export async function publishPromotionBoard(client) {
  const { publishPubgDramaSale } = await import('./pubgDramaSale2026.js');
  return publishPubgDramaSale(client, { tagEveryone: true, tagMember: true });
}
