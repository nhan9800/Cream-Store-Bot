# Curated Cenar UI emojis

Các file này được giữ lại để việc đồng bộ emoji Discord có thể lặp lại an toàn và có nguồn rõ ràng.

| Tên Discord | Nguồn chọn | Công năng |
| --- | --- | --- |
| `cenar_warranty_shield` | [Emoji.gg Shield](https://emoji.gg/emoji/998200-shield) | Tiêu đề bảo hành |
| `cenar_purchase_date` | [Emoji.gg Calendar](https://emoji.gg/emoji/530749-calendar) | Ngày mua |
